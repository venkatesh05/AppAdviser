...
import com.tigo.appadvisor.AppAdvisor;
...
public class WebIntent extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) {
        try {
            ...
            if (action.equals("startActivity")) {
            	...
            	Toast.makeText(this.cordova.getActivity().getApplicationContext(), "onNewIntent 1", Toast.LENGTH_LONG).show();
                if (args.length() != 0) {
                    //return new PluginResult(PluginResult.Status.INVALID_ACTION);
                    callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.INVALID_ACTION));
                    return false;
                }
                Toast.makeText(this.cordova.getActivity().getApplicationContext(), "onNewIntent 2", Toast.LENGTH_LONG).show();
    ...
    void startActivity(String action, Uri uri, String type, Map<String, String> extras) {
        ...
        Toast.makeText(this.cordova.getActivity().getApplicationContext(), "startActivity", Toast.LENGTH_LONG).show();
